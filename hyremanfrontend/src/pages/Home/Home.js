                ...
                <div >
                    <nav className='d-flex align-content-center justify-content-between w-100' >
                        ...
                        <div className='d-flex align-content-center justify-content-around p-5 navRight'>
                            ...
                            <NavLink to='/applicant-signup'>
                                <RoundedButton title='Upload Resume' className='ps-4 pe-4 py-2 rounded-pill text-white border border-primary bg-primary ' />
                            </NavLink>
                        </div>
                    </nav>
                    ...
                    <div className='d-flex justify-content-center text-center mt-5'>
                        <div className='w-50'>
                            ...
                            <span style={{color: '#D2D620'}}>Exposing</span> job seekers to<br/>better opportunities
                            </h1>
                            <p className='text-white py-1'>Searching for candidates can be stressful. Let’s help <br/>make it stress-free</p>
                            <NavLink to='recruiter-signup'>
                                <RoundedButton title='Discover Talents' className='px-4 py-2 rounded-pill text-white border border-primary   bg-primary my-2'/>
                            </NavLink>
                        </div> 
                    </div>
